...
import {
    LayoutDashboard, Images, ListVideo, Monitor, Flag,
    HelpCircleIcon, Headset, Settings, UserCircle,
    ClipboardMinus, LogOut, Users, Shield, Lock, Database, Group
} from "lucide-react";
import DashboardContent from "@/src/app/dashboardcontent/page";
...
import Help from "@/src/app/help/page";
import Profile from "@/src/app/profile/page";
import Createadmin from "@/src/app/createadmin/page";
import CrreateUser from "@/src/app/createuser/page";
import CreateSuperAdmin from "@/src/app/createsuperadmin/page";
...
export const getDashboardComponents = (userRole: UserRole | number): DashboardComponents => {
