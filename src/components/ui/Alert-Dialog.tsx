...
// Define generic type for HTML div props
...
interface AlertDialogHeaderProps extends DivProps {
  className?: string;
}

interface AlertDialogFooterProps extends DivProps {
  className?: string;
}
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    className={cn(
      "text-sm text-muted-foreground text-black overflow-hidden",
      className
    )}
    {...props}
  />
